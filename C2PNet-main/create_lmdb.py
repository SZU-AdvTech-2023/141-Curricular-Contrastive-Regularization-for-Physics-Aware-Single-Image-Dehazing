...
parser.add_argument('--n1_path', type=str, default='/home2/lsy/OTS/pred_DCP17_its', help='negative path')
parser.add_argument('--n2_path', type=str, default='/home2/lsy/OTS/pred_AOD_19_its', help='negative path')
parser.add_argument('--n3_path', type=str, default='/home2/lsy/OTS/pred_GCA31_its', help='negative path')
parser.add_argument('--n4_path', type=str, default='/home2/lsy/OTS/pred_GDN_its', help='negative path')
parser.add_argument('--n5_path', type=str, default='/home2/lsy/OTS/pred_FFA_its', help='negative path')
parser.add_argument('--n6_path', type=str, default='/home2/lsy/OTS/pred_FFANEW_its', help='negative path')
parser.add_argument('--dpath', type=str, default='/home2/lsy/OTS', help='LMDB save path')
parser.add_argument('--name', type=str, default='ITS', help='LMDB name')

opt = parser.parse_args()

print("Received arguments:")
print(f"dpath: {opt.dpath}")
print(f"name: {opt.name}")

class RESIDE_Dataset_C2R(data.Dataset):
    def __init__(self, path, size='whole img', format='.jpg'):
...
def data2lmdb(dpath, name="train", write_frequency=5, num_workers=8):
   # dataset = RESIDE_Dataset_C2R('/mnt/lab/zhengy/zy/haze/RESIDE/ITS', size='whole img')
    dataset = RESIDE_Dataset_C2R('/home2/lsy/OTS', size='whole img')
